...
import { Compass, Calendar, BookMarked, Users, Trophy, BarChart2 } from 'lucide-react';
  ...
  return (
    <aside className="hidden md:flex flex-col fixed left-0 top-0 h-full z-50
      ...
      <button onClick={() => navigate('/')}
        className="flex items-center gap-3 px-3 lg:px-4 py-5 border-b border-[var(--border)] w-full text-left
          hover:bg-[var(--bg-tertiary)] transition-all overflow-hidden min-h-[64px]">
