...
export const HomePage = () => {
  ...
  const featuredAnime = animeData[16];
  const trendingAnime = animeData.slice(0, 5);
  const newReleases = animeData.slice(0, 8);
    ...
    <div className="space-y-12">
      ...
      >
        ...
        <div className="absolute inset-0"
          style={{ background: 'linear-gradient(to right, var(--bg-primary) 0%, rgba(0,0,0,0.5) 60%, transparent 100%)' }}
        />
      ...
      <section>
        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
          {trendingAnime.map((anime, i) => (
            <div key={anime.id} className="relative shrink-0 w-36 md:w-44">
